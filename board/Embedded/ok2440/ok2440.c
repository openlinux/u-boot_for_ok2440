...
#define HSPW_240320_NEC		(8)  //Adjust the horizontal displacement of the screen :tekkamanninja@163.com
#define HSPW_240320_TD		(8)  //64MB nand mini2440 is 36 ,128MB is 23
				      //+ ： -->    - : <--
